    ...
    public function index()
{
    ...
    // Fetch activities with their weather conditions
    $activities = Activity::with(['weatherCondition.precipitations', 'weatherCondition.winddirections'])->get();

    // Return the home view with the 7-day forecast and activities data
    return view('home', ['sevenDayForecast' => $forecastData, 'activities' => $activities]);
}
